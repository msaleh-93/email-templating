...
export function requestDetails() {
  const policyViolations = $.if(
    ...
    adminRequest = $.if("adminRequest", [
      spacingY(16),
      dividerH(),
      t.tr(
        null,
        t.td({ style: { padding: 0 } }, REQUEST_OPTIONS.map(renderOptions)),
      ),
    ]),
    autoReject = $.if("autoReject", [
      spacingY(16),
      dividerH(),
      spacingY(16),
    ...
    bookingApproval = $.if("bookingApproval", [
      spacingY(16),
      dividerH(),
      t.tr(
        null,
        t.td({ style: { padding: 0 } }, APPROVAL_OPTIONS.map(renderOptions)),
      ),
    ]),
    bookingRejection = $.if("bookingRejection", [
      spacingY(16),
      dividerH(),
      spacingY(16),
      t.h3({ style: VIOLATION_TITLE_STYLE }, "Reason of Rejection"),
